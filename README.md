...
- 2024/12/21
  1. Added support for zmk-studio (just flash the left half to use it).
- 2024/10/24
  1. Modified power supply mode to reduce power consumption.
  2. Fixed the automatic shut-off feature for RGB power supply.
- 2025/3/30
  1. Increased idle sleep timeout to 1 hour. Increased debounce time. Optimized power consumption after sleep.
- 2025/8/22
